...
// const { assert: { isFunction, strictEqual, oneOf } } = require('chai')   //same idea as above

const { toDiceNotation, roll } = require('../lib/dice')

describe('dice', () => {                    //describes the greater "dice" module which BOTH live in
  describe('toDiceNotation', () => {
    it('should be a function', () => {
      isFunction(toDiceNotation)
    })
    it('should convert an obj with a count and sides property to dice notation', () => {
